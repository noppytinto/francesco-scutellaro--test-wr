...
export const getBookingsResponseData = (): APIBooking[] => {
  ...
  return [
    {
      id: "1",
      travel_id: mockedTravels.find((travel) => travel.id === "18")!,
    ...
    {
      id: "2",
      travel_id: mockedTravels.find((travel) => travel.id === "2")!,
      customer: mockedCustomers.find((customer) => customer.id === "8")!,
      payment_method: "Paypal",
    },
    {
      id: "3",
      travel_id: mockedTravels.find((travel) => travel.id === "1")!,
    ...
    {
      id: "4",
      travel_id: mockedTravels.find((travel) => travel.id === "7")!,
      customer: mockedCustomers.find((customer) => customer.id === "4")!,
      payment_method: "Credit transfer",
    },
    {
      id: "5",
      travel_id: mockedTravels.find((travel) => travel.id === "5")!,
    ...
    {
      id: "8",
      travel_id: mockedTravels.find((travel) => travel.id === "10")!,
    ...
    {
      id: "10",
      travel_id: mockedTravels.find((travel) => travel.id === "4")!,
      customer: mockedCustomers.find((customer) => customer.id === "14")!,
      payment_method: "Paypal",
    },
    {
      id: "11",
      travel_id: mockedTravels.find((travel) => travel.id === "12")!,
      customer: mockedCustomers.find((customer) => customer.id === "15")!,
      payment_method: "Revolut",
    },
    {
      id: "12",
      travel_id: mockedTravels.find((travel) => travel.id === "14")!,
      customer: mockedCustomers.find((customer) => customer.id === "16")!,
      payment_method: "Credit transfer",
    },
    {
      id: "13",
      travel_id: mockedTravels.find((travel) => travel.id === "15")!,
    ...
    {
      id: "15",
      travel_id: mockedTravels.find((travel) => travel.id === "20")!,
